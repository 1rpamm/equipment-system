...
class DetailsControllerTest < ActionController::TestCase
  ...
  test "should create detail" do
    assert_difference('Detail.count') do
      post :create, detail: { accepted_at: @detail.accepted_at, deleted_at: @detail.deleted_at, rev: @detail.rev, serial: @detail.serial }
    end
  ...
  test "should update detail" do
    put :update, id: @detail, detail: { accepted_at: @detail.accepted_at, deleted_at: @detail.deleted_at, rev: @detail.rev, serial: @detail.serial }
    assert_redirected_to detail_path(assigns(:detail))
  end
